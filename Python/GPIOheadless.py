...
while True:
    ...
    print(yarr)
    x2 = x1
    draw.line((x+10, bottom-10,  x+width, bottom-10), fill=255)
    draw.line((x+10, bottom-10, x+10, top), fill=255)
    draw.text((x+40, bottom-9), 'Time (s)',  font=font, fill=255)
    draw2.text((x, top), 'a (m/s2)',  font=font, fill=255)
    #draw2.text((0,0), 'a (m/s2)',  font=font, fill=255)
    w = image2.rotate(90)
    image.paste(w, (0,0,50,12))
    #image.paste(w)
